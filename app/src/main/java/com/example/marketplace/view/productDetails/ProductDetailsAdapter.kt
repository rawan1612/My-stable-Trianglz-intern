...
import com.example.marketplace.view.productsList.SimilarIPostsAdapter
...
class ProductDetailsAdapter(var context : Context, private val handle: IIntentHandle) : ListAdapter<DataModelInterface, RecyclerView.ViewHolder>(ProductDetailsDiffUtil()) {
    ...
    private val similarProductsAdapter by lazy { SimilarIPostsAdapter(context) }
